					...
					<div class="image-screen">
						<div class="header">
							<?php if ( ! empty( $settings['eael_interactive_card_front_panel_counter'] ) ) {
								printf( '<%1$s class="card-number">', Helper::eael_validate_html_tag( $settings['counter_html_tag'] ) );
								echo $settings['eael_interactive_card_front_panel_counter'];
								printf( '</%1$s>', Helper::eael_validate_html_tag( $settings['counter_html_tag'] ) );
							} ?>
