    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '.eael-offcanvas-close-{{ID}}' => 'order: {{VALUE}};',
                ],
            ]
        );
        ...
        <div class="eael-offcanvas-header">
            ...
            <div <?php echo $this->get_render_attribute_string('close-button'); ?>>
                <?php if (isset($settings['__fa4_migrated']['close_button_icon_new']) || empty($settings['close_button_icon'])) { ?>
                    <?php if ( isset( $settings['close_button_icon_new'] ) ) {
                        Icons_Manager::render_icon( $settings['close_button_icon_new'], [ 'aria-hidden' => 'true' ] );
                    } ?>
                <?php } else { ?>
