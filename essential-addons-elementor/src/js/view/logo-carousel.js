...
var LogoCarouselHandler = function($scope, $) {
	...
	ea.hooks.addAction("ea-lightbox-triggered", "ea", LogoCarouselLoader);
	ea.hooks.addAction("ea-advanced-tabs-triggered", "ea", LogoCarouselLoader);
	ea.hooks.addAction("ea-advanced-accordion-triggered", "ea", LogoCarouselLoader);
};
