 ...
 * @since 2.3
 */
class Types_Field_Type_Embedded_Media_Factory implements Types_Field_Factory_Interface {

	/**
	 * @param array $data
	 *
	 * @return Types_Field_Type_Embedded_Media
	 */
	public function get_field( $data = array() ) {
		...
		return new Types_Field_Type_Embedded_Media( $data );
	}
	 ...
	 *
	 * @return Types_Field_Type_Embedded_Media_Mapper_Legacy
	 */
	public function get_mapper( Types_Field_Gateway_Interface $gateway ) {
		return new Types_Field_Type_Embedded_Media_Mapper_Legacy( $this, $gateway );
	}
	 ...
	 *
	 * @return Types_Field_Type_Embedded_Media_View_Frontend|false
	 */
	public function get_view_frontend( Types_Field_Interface $field, $user_params ) {
		if ( ! $field instanceof Types_Field_Type_Embedded_Media ) {
			return false;
		}

		return new Types_Field_Type_Embedded_Media_View_Frontend( $field, $user_params );
	}
