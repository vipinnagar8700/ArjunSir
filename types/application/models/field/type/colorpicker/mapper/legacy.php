...
/**
 * Mapper for "Colorpicker" field
 *
 * @since 2.3
 */
class Types_Field_Type_Colorpicker_Mapper_Legacy extends Types_Field_Mapper_Abstract {

	/**
	 * @var Types_Field_Type_Colorpicker_Factory
	 */
	...
	public function find_by_id( $id, $id_post ) {
		...
		if ( $field['type'] !== 'colorpicker' ) {
			throw new RuntimeException( 'Types_Field_Type_Colorpicker_Mapper_Legacy can not map type: ' . $field['type'] );
		}
