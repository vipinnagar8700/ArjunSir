...
/**
 * Mapper for "Url" field
 *
 * @since 2.3
 */
class Types_Field_Type_Url_Mapper_Legacy extends Types_Field_Mapper_Abstract {

	/**
	 * @var Types_Field_Type_Url_Factory
	 */
	...
	public function find_by_id( $id, $id_post ) {
		...
		if( $field['type'] !== 'url' ) {
			throw new RuntimeException( 'Types_Field_Type_Url_Mapper_Legacy can not map type: ' . $field['type'] );
		}
