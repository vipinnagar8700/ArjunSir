...
/**
 * Mapper for "Date" field
 *
 * @since 2.3
 */
class Types_Field_Type_Date_Mapper_Legacy extends Types_Field_Mapper_Abstract {

	/**
	 * @var Types_Field_Type_Date_Factory
	 */
	...
	public function find_by_id( $id, $id_post ) {
		...
		if ( $field['type'] !== 'date' ) {
			throw new RuntimeException( 'Types_Field_Type_Date_Mapper_Legacy can not map type: ' . $field['type'] );
		}
