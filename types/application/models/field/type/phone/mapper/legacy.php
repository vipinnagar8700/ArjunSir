 ...
 * @since 2.3
 */
class Types_Field_Type_Phone_Mapper_Legacy extends Types_Field_Mapper_Abstract {

	/**
	 * @var Types_Field_Type_Phone_Factory
	 */
	 ...
	 * @param int $id_post
	 *
	 * @return null|Types_Field_Type_Phone
	 * @throws Exception
	 */
	public function find_by_id( $id, $id_post ) {
		...
		if ( $field['type'] !== 'phone' ) {
			throw new RuntimeException( 'Types_Field_Type_Phone_Mapper_Legacy can not map type: ' . $field['type'] );
		}
