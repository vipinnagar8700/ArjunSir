...
/**
 * Mapper for "Multiple_Lines" field
 *
 * @since 2.3
 */
class Types_Field_Type_Multiple_Lines_Mapper_Legacy extends Types_Field_Mapper_Abstract {

	/**
	 * @var Types_Field_Type_Multiple_Lines_Factory
	 */
	...
	public function find_by_id( $id, $id_post ) {
		...
		if ( $field['type'] !== 'textarea' ) {
			throw new Exception( 'Types_Field_Type_Multiple_Lines_Mapper_Legacy can not map type: ' . $field['type'] );
		}
