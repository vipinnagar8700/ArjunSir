 ...
 * @since 2.3
 */
class Types_Field_Type_Audio_Factory implements Types_Field_Factory_Interface {
	...
	public function get_field( $data = array() ) {
		...
		return new Types_Field_Type_Audio( $data );
	}
	 ...
	 *
	 * @return Types_Field_Type_Audio_Mapper_Legacy
	 */
	public function get_mapper( Types_Field_Gateway_Interface $gateway ) {
		return new Types_Field_Type_Audio_Mapper_Legacy( $this, $gateway );
	}
	 ...
	 *
	 * @return Types_Field_Type_Audio_View_Frontend|false
	 */
	public function get_view_frontend( Types_Field_Interface $field, $user_params ) {
		if ( ! $field instanceof Types_Field_Type_Audio ) {
			return false;
		}

		return new Types_Field_Type_Audio_View_Frontend( $field, $user_params );
	}
