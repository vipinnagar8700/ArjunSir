 ...
 */
class BlockReferenceExpression extends \OTGS\Toolset\Twig\Node\Expression\AbstractExpression
{
    /**
     * @param Node|null $template
     */
    public function __construct(\OTGS\Toolset\Twig_NodeInterface $name, $template = null, $lineno = -1, $tag = null)
    {
        if (\is_bool($template)) {
    ...
    private function compileTemplateCall(\OTGS\Toolset\Twig\Compiler $compiler, $method)
    {
    ...
    private function compileBlockArguments(\OTGS\Toolset\Twig\Compiler $compiler)
    {
...
\class_alias('OTGS\\Toolset\\Twig\\Node\\Expression\\BlockReferenceExpression', 'OTGS\\Toolset\\Twig_Node_Expression_BlockReference');
