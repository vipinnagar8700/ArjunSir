...
if ( ! class_exists( 'Toolset_Utils', false ) ) {
	...
	class Toolset_Utils {
		...
		public static function get_attachment_id_by_url( $url ) {
			$attachment_utils = new \OTGS\Toolset\Common\Utils\Attachments(
				new \OTGS\Toolset\Common\Utils\TypesGuidIdGateway(), \OTGS\Toolset\Common\WPML\WpmlService::get_instance()
			);
