...
class Toolset_User_Editors_Editor_Screen_Visual_Composer_Backend
	...
	public function initialize() {
		...
		// Registers the WPBakery Visual Composer editor as one of the allowed default user editors for Content Templates.
		add_filter( 'wpv_filter_wpv_default_user_editor', array( $this, 'register_visual_composer_as_default_user_editor_option' ) );
	...
	*/
	...
	public function save_vc_custom_css( $content_template_id ) {
		...
		$content_template_has_vc = ( get_post_meta( $content_template_id, '_toolset_user_editors_editor_choice', true ) === Toolset_User_Editors_Editor_Visual_Composer::VC_SCREEN_ID );
		if ( $content_template_has_vc ) {
	 ...
	 * @return array
	 */
	public function register_visual_composer_as_default_user_editor_option( $default_editors ) {
		array_push( $default_editors, Toolset_User_Editors_Editor_Visual_Composer::VC_SCREEN_ID );
