 ...
 * @since 1.9
 */
class Toolset_Field_Instance_Term extends Toolset_Field_Instance {
	...
	public function update_all_values( $values ) {
		...
		if( ! $this->get_definition()->is_repeatable() ) {
	 ...
	 */
	public function get_order_accessor() {
		return new Toolset_Field_Accessor_Termmeta(
			$this->get_object_id(), $this->get_order_meta_name(), false, true
		);
	}
