			...
			foreach ($args as $method => $v) {
				...
				if (is_callable(array('Wpcf_Validate', $method))) {
					...
					// Use CakePHP method
						...
						&& is_callable(array(self::$_validation_object , self::$_cake_aliases[$method])))
						|| is_callable(array(self::$_validation_object , $method))) {
					...
					// Validate
					if (isset(self::$_cake_aliases[$method]) && is_callable(array(self::$_validation_object , self::$_cake_aliases[$method]))) {
