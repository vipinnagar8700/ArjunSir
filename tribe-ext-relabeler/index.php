	...
	public function add_settings() {
		...
		$fields = array(
			...
			'label_event_single' => array(
				'type'            => 'text',
				'label'           => esc_html__( 'Classes', 'the-events-calendar' ),
				'default'         => esc_attr__( 'Classes', 'the-events-calendar' ),
				'tooltip'         => esc_html__( 'Singular label for Classes.', 'tribe-extension' ),
				'validation_type' => 'html',
			),
			'label_event_single_lowercase' => array(
				'type'            => 'text',
				'label'           => esc_html__( 'class', 'the-events-calendar' ),
				'default'         => esc_attr__( 'class', 'the-events-calendar' ),
				'tooltip'         => sprintf(
					esc_html__( 'Lowercase singular label for Classes. You might wish to also modify the "Classes URL Slug" found in the %s classes settings tab.', 'tribe-extension' ),
			...
			'label_event_plural' => array(
				...
				'label'           => esc_html__( 'Classes', 'the-events-calendar' ),
				'default'         => esc_attr__( 'Classes', 'the-events-calendar' ),
				'tooltip'         => esc_html__( 'Plural label for Classes.', 'tribe-extension' ),
				'validation_type' => 'html',
			),
			'label_event_plural_lowercase' => array(
				...
				'default'         => esc_attr__( 'classes', 'the-events-calendar' ),
				'tooltip'         => sprintf(
					esc_html__( 'Lowercase plural label for Classes. You might wish to also modify the "Single Class URL Slug" found in the %s classes settings tab.','tribe-extension' ),
					$this->general_settings_tab_link()
				),
				'validation_type' => 'html',
			),
