...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	$ticket_form_location_options = [
		'tribe_events_single_event_after_the_meta'     => __( 'Below the class details [default]', 'event-tickets' ),
		'tribe_events_single_event_before_the_meta'    => __( 'Above the class details', 'event-tickets' ),
		'tribe_events_single_event_after_the_content'  => __( 'Below the class description', 'event-tickets' ),
		'tribe_events_single_event_before_the_content' => __( 'Above the class description', 'event-tickets' ),
	];
	...
	$tec_fields = [
		...
		'tooltip'         => esc_html__( 'This setting only impacts classes made with the classic editor.', 'event-tickets' ),
