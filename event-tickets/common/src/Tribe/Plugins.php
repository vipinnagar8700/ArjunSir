...
if ( ! class_exists( 'Tribe__Plugins' ) ) {
	...
	class Tribe__Plugins {
		...
		private $tribe_plugins = [
			...
			[
				'short_name'   => 'Community Registrations',
