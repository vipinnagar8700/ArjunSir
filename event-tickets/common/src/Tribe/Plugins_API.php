	...
	public function get_products() {
		$products = array(
			'the-events-calendar' => array(
				'title' => __( 'The Classes Calendar', 'tribe-common' ),
			...
			'event-aggregator' => array(
				'title' => __( 'Class Aggregator', 'tribe-common' ),
			...
			'events-calendar-pro' => array(
				'title' => __( 'Classes Calendar PRO', 'tribe-common' ),
				...
				'description' => sprintf(
					__( 'The Classes Calendar PRO is a paid Add-On to our open source WordPress plugin %1$sThe Events Calendar%2$s. PRO offers a whole host of calendar features including recurring events, custom event attributes, saved venues and organizers, venue pages, advanced event admin and lots more.', 'tribe-common' ),
			...
			'event-tickets' => array(
				'title' => __( 'Class Registrations', 'tribe-common' ),
				'slug' => 'event-tickets',
				'link' => null,
				'description' => __( 'Class Registrations provides a simple way for visitors to RSVP to your events. As a standalone plugin, it enables you to add RSVP functionality to posts or pages. When paired with The Events Calendar, you can add that same RSVP functionality directly to your event listings.', 'tribe-common' ),
			...
			'event-tickets-plus' => array(
				'title' => __( 'Class Registrations Plus', 'tribe-common' ),
