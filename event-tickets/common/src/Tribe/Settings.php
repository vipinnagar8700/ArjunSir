...
if ( ! class_exists( 'Tribe__Settings' ) ) {
	...
	class Tribe__Settings {
		...
		public function __construct() {
			...
			$this->menuName    = apply_filters( 'tribe_settings_menu_name', esc_html__( 'Classes', 'tribe-common' ) );
		...
		public function addPage() {
			...
			if ( ! is_multisite() || ( is_multisite() && '0' == Tribe__Settings_Manager::get_network_option( 'allSettingsTabsHidden', '0' ) ) ) {
				if ( post_type_exists( 'tribe_events' ) ) {
					...
					add_menu_page(
						esc_html__( 'Classes', 'tribe-common' ),
						esc_html__( 'Classes', 'tribe-common' ),
				...
				$this->admin_page = add_submenu_page(
					...
					esc_html__( 'Classes Settings', 'tribe-common' ),
		...
		public function addNetworkPage() {
			...
			$this->admin_page = add_submenu_page(
				'settings.php', esc_html__( 'Classes Settings', 'tribe-common' ), esc_html__( 'Classes Settings', 'tribe-common' ), $this->requiredCap, $this->adminSlug, array(
					$this,
					'generatePage',
				)
			);
			...
			$this->admin_page = add_submenu_page(
				'settings.php',
				esc_html__( 'Classes Help', 'tribe-common' ),
				esc_html__( 'Classes Help', 'tribe-common' ),
				$this->requiredCap,
				$this->help_slug,
				array(
